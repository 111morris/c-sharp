// use arrays tp store student names and assignment scores
...
// the application should include the exam score and the impact that extra credit work has on the student's final grade. The format of the updated score report should appear as follows:
